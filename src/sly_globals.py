...
coffee_leaves_url = 'https://data.mendeley.com/api/datasets-v2/datasets/c5yvn32dzg/zip/download?version=2'

arch_name = 'RoCoLe_ A robusta coffee leaf images dataset .zip'
...
sample_percent = round(int(os.environ["modal.state.samplePercent"]) * 15.6)
